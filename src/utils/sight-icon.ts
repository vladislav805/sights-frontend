...
<path transform="matrix(8.1 0 0 8.1 0 -13)" d="m13 0c-7.2 0-13 5.8-13 13 0.0057 1.4 0.0071 1.4 1 4 4.1 7.7 7.9 15 12 23l12-23c0.99-2.8 0.99-2.8 1-4 0-7.2-5.8-13-13-13zm0 9c2.2 1e-7 4 1.8 4 4s-1.8 4-4 4-4-1.8-4-4c1e-7 -2.2 1.8-4 4-4z" fill="#${color}" stroke="#${color}" stroke-width=".4"/>
...
export const getIconBySight = (sight: ISight): L.Icon => {
